...
class RideController extends GetxController implements GetxService {
  ...
  void resumeCountingTimeState(int duration){
     if(duration < 60){
       ...
       secondCount = 1;
       stateCount = 2;
       counter =duration - 120 ;
       totalTimeSecond = 305 - duration ;
     }else{
       firstCount =1;
       secondCount = 1;
       thirdCount =1;
