      ...
      body: SafeArea(child: Center(
        child: GetBuilder<LocationController>(builder: (locationController) {
          return Stack(children: [
            GoogleMap(
              initialCameraPosition: CameraPosition(target: widget.oldLocationExist ? LatLng(
              locationController.pickPosition.latitude, locationController.pickPosition.longitude) : widget.onLocationPicked != null ? LatLng(
            ...
            Positioned(
              ...
              child: locationController.picking ?  Center(child: SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,)) : ButtonWidget(
