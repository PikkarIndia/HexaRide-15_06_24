    ...
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: Column(crossAxisAlignment:CrossAxisAlignment.start, children: [
          ...
          Text(widget.subTitle!.tr,style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).hintColor),) : const SizedBox()
        ])),
        ...
        Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeExtraSmall),
            ...
            child: Text(PriceConverter.convertPrice(widget.amount), style: textSemiBold.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColorDark))) :
        widget.paymentType!=null?
        Text(widget.paymentType!,style: textRegular.copyWith(color: Theme.of(context).primaryColor)):

        widget.discount?
        Text('-${PriceConverter.convertPrice(widget.amount)}', style: textRegular.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColor)):
        Text(PriceConverter.convertPrice(widget.amount), style: textRegular.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColor)),
